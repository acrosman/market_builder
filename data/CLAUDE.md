...
- **planet_names.json**, **station_names.json**, **corporation_names.json** - Name pools for world generation and for the NPC corporations created by `src/agents/corporateAI.js`
...
| `npc_corporations` | `src/agents/corporateAI.js` | How many rivals exist, their starting cash, and the cash floors gating building and acquisition |
| `investors` | `src/agents/investorPool.js` | The investing public's size, capital, savings rate, belief dispersion and position limits |
